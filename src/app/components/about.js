...
export default function About({ skills, currentSkillIndex, showSkill }) {
  return (
    <>
      ...
      {/* Residence/Uni Info */}
      <p style={{ fontSize: "20px", marginTop: "2rem" }}>
          I AM A CANADIAN CITIZEN CURRENTLY BASED IN HONOLULU, HAWAI‘I, PURSUING MY MASTER’S IN COMPUTER SCIENCE AT THE UNIVERSITY OF HAWAI‘I AT MĀNOA. I HOLD A BACHELOR’S DEGREE IN ENGINEERING PHYSICS WITH A SPECIALIZATION IN COMPUTING APPLICATIONS FROM QUEEN’S UNIVERSITY.</p>
      {/* GITHUB Link */}
      <p style={{ fontSize: "20px", marginTop: "2rem" }}>
